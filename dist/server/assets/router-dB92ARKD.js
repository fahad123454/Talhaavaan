  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `mx-auto max-w-6xl px-5 transition-all duration-300 ${scrolled ? "" : ""}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `flex items-center justify-between rounded-full px-5 py-2.5 transition-all duration-300 ${scrolled ? "glass shadow-elegant" : ""}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-bold tracking-tight", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-8 w-8 place-items-center rounded-full bg-gradient-to-br from-primary to-accent text-primary-foreground", children: "T" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: "Talha Avaan" })
                  ] }),
            ...
            open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden mt-2 glass rounded-2xl p-3 flex flex-col gap-1", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative overflow-hidden border-t border-border/50 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "aria-hidden": true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-6xl px-6 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br from-primary to-accent text-primary-foreground font-bold", children: "T" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold", children: "Talha Avaan" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-md", children: "Cinematic VFX editor crafting high-impact visuals for short films, music videos, ads and creators worldwide." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: socials.map(({ icon: Icon2, label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href,
              target: "_blank",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold text-foreground mb-4", children: "Navigate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/work", className: "hover:text-foreground", children: "Work" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold text-foreground mb-4", children: "Get in touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:talhaavaan@gmail.com", className: "hover:text-foreground", children: "talhaavaan@gmail.com" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "size-4 text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Available worldwide" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-col-reverse items-center justify-between gap-4 border-t border-border/50 pt-6 md:flex-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Talha Avaan. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Crafted with cinematic precision." })
      ] })
    ] })
  ] });
}
const appCss = "/assets/styles-BhPVKNPL.css";
...
const Route$4 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Talha Avaan — Cinematic VFX Editor & Motion Designer" },
      {
        name: "description",
        content: "Talha Avaan is a VFX editor crafting cinematic visual effects, motion design and color for short films, music videos and ads."
      },
      { name: "author", content: "Talha Avaan" },
...
const $$splitComponentImporter$3 = () => import("./work-Dd6qA3AD.js");
const Route$3 = createFileRoute("/work")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Selected VFX, motion design and color grading work by Talha Avaan — short films, music videos, commercials and more."
    }, {
      property: "og:title",
      content: "Work — Talha Avaan VFX Showcase"
    }, {
...
const $$splitComponentImporter$2 = () => import("./contact-Du3AwhkC.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Have a project in mind? Get in touch with Talha Avaan to discuss VFX, editing and motion design."
    }, {
      property: "og:title",
      content: "Contact Talha Avaan"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$1 = () => import("./about-12CDq8d2.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get to know Talha Avaan — a VFX editor with 7+ years crafting cinematic visuals for short films, music videos and brand campaigns."
    }, {
      property: "og:title",
      content: "About Talha Avaan"
    }, {
      property: "og:description",
...
const $$splitComponentImporter = () => import("./index-CAhxSwLi.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Award-winning VFX editor blending cinematic storytelling with explosive visual effects. View showreel, services and selected work."
    }, {
      property: "og:title",
      content: "Talha Avaan — Cinematic VFX Editor"
    }, {
      property: "og:description",
