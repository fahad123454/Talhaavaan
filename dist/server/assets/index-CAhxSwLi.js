import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-uGdKt4ZC.js";
import { c as createLucideIcon, L as Link } from "./router-dB92ARKD.js";
import { P as Play, a as cn } from "./utils-Be7ud1EP.js";
...
function CinematicHero({
  ...
  cardDescription = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "From invisible plate cleanups to explosive sci-fi spectacle — Talha sculpts every frame with a director's eye and a colorist's care." }),
  metricValue = 120,
  ...
  const mainCardRef = reactExports.useRef(null);
  const mockupRef = reactExports.useRef(null);
    ...
    const handleMouseMove = (e) => {
      ...
      requestRef.current = requestAnimationFrame(() => {
        if (mainCardRef.current && mockupRef.current) {
          ...
          gsapWithCSS.to(mockupRef.current, {
            rotationY: xVal * 12,
            rotationX: -yVal * 12,
            ease: "power3.out",
            duration: 1.2,
  ...
  reactExports.useEffect(() => {
    const ctx = gsapWithCSS.context(() => {
      ...
      gsapWithCSS.set(".text-reveal", {
        autoAlpha: 1,
        clipPath: "inset(0 100% 0 0)"
      });
      gsapWithCSS.set(".main-card", { y: window.innerHeight + 200, autoAlpha: 1 });
      gsapWithCSS.set(
        [".card-left-text", ".card-right-text", ".mockup-scroll-wrapper", ".floating-badge", ".phone-widget"],
        { autoAlpha: 0 }
      );
      gsapWithCSS.set(".cta-wrapper", { autoAlpha: 0, scale: 0.8, filter: "blur(30px)" });
      const introTl = gsapWithCSS.timeline({ delay: 0.3 });
      ...
      const scrollTl = gsapWithCSS.timeline({
        scrollTrigger: {
      ...
      scrollTl.to(
        ...
        0
      ).to(".main-card", { y: 0, ease: "power3.inOut", duration: 2 }, 0).to(".main-card", {
        width: "100%",
        height: "100%",
        borderRadius: "0px",
        ease: "power3.inOut",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { dangerouslySetInnerHTML: { __html: INJECTED_STYLES } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-grid-theme", "aria-hidden": true }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-text-wrapper absolute inset-0 flex flex-col items-center justify-center text-center px-6 z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-track gsap-reveal inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-xs uppercase tracking-[0.3em] text-muted-foreground mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-3 text-primary" }),
              "VFX Editor & Motion Designer"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-track gsap-reveal text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.95] text-3d-matte", children: brandName }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-6 text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight max-w-4xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-track gsap-reveal block text-silver-matte", children: tagline1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-reveal gsap-reveal block text-gradient-primary mt-2", children: tagline2 })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-track gsap-reveal mt-8 max-w-xl text-base md:text-lg text-muted-foreground", children: "Scroll to explore the craft." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-sheen" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full flex flex-col lg:flex-row items-center justify-between gap-8 p-6 md:p-12 lg:p-20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-left-text gsap-reveal flex-1 max-w-md text-center lg:text-left", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.25em] text-white/70 floating-ui-badge mb-6", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-primary animate-pulse" }),
                      "Available for Projects"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl md:text-5xl font-bold tracking-tight text-card-silver-matte leading-tight", children: cardHeading }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-sm md:text-base text-white/60 leading-relaxed", children: cardDescription }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Link,
                        {
                          to: "/work",
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-1/2 -translate-x-1/2 z-30 h-6 w-24 rounded-full bg-black" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "screen-glare absolute inset-0 z-20" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-[7px] rounded-[36px] overflow-hidden bg-gradient-to-br from-[#1a0f1f] via-[#0f0a14] to-[#0a0608]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "img",
                                {
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full flex flex-col p-5 pt-12 text-white", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "phone-widget gsap-reveal text-[10px] uppercase tracking-[0.2em] text-white/60", children: "Now Playing" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "phone-widget gsap-reveal mt-1 text-lg font-bold leading-tight", children: "Showreel · 2025" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "phone-widget gsap-reveal relative mx-auto mt-6 grid place-items-center", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "160", height: "160", viewBox: "0 0 160 160", children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "circle",
                                      {
                                        cx: "80",
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "ringGrad", x1: "0", y1: "0", x2: "1", y2: "1", children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.78 0.22 45)" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.55 0.22 285)" })
                                    ] }) })
                                  ] }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-4xl font-bold text-card-silver-matte leading-none", children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref: counterRef, children: "0" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: "+" })
                                    ] }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[9px] uppercase tracking-[0.2em] text-white/50", children: metricLabel })
                                  ] }) })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto grid grid-cols-3 gap-2", children: [
                                  { icon: Film, label: "Edits" },
                                  { icon: WandSparkles, label: "VFX" },
                                  { icon: Layers, label: "Comp" }
                                ].map(({ icon: Icon, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "div",
                                  {
                                    className: "phone-widget gsap-reveal widget-depth rounded-xl p-2 text-center",
                                    children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "mx-auto size-3.5 text-primary" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[9px] uppercase tracking-wider text-white/60", children: label })
                                    ]
                                  },
                                  label
                                )) })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-right-text gsap-reveal hidden lg:flex flex-col gap-4 max-w-[200px]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "floating-badge gsap-reveal floating-ui-badge rounded-2xl p-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-card-silver-matte", children: "7+" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[10px] uppercase tracking-widest text-white/60", children: "Years Experience" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "floating-badge gsap-reveal floating-ui-badge rounded-2xl p-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-card-silver-matte", children: "40+" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[10px] uppercase tracking-widest text-white/60", children: "Studios & Brands" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "floating-badge gsap-reveal floating-ui-badge rounded-2xl p-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-2 rounded-full bg-emerald-400 animate-pulse" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-white/80", children: "Online now" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[10px] uppercase tracking-widest text-white/50", children: "Replies in ~2h" })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cta-wrapper gsap-reveal absolute inset-0 grid place-items-center z-40 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl px-6 pointer-events-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-4xl md:text-6xl font-bold tracking-tight text-card-silver-matte", children: ctaHeading }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base md:text-lg text-white/60", children: ctaDescription }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center justify-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Link,
                      {
                        to: "/contact",
                        className: "btn-modern-light inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-semibold",
                        children: "Start a project →"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      ...
                      {
                        to: "/work",
                        className: "btn-modern-dark inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-semibold",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "size-4 fill-current" }),
                          "Showreel"
                        ]
...
const TestimonialStack = ({
  ...
  const dragStartRef = reactExports.useRef(0);
  const cardRefs = reactExports.useRef([]);
  const totalCards = testimonials2.length;
  ...
  if (!testimonials2?.length) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-2xl mx-auto h-[420px] sm:h-[380px]", children: [
    testimonials2.map((testimonial, index) => {
      const displayOrder = (index - activeIndex + totalCards) % totalCards;
      const style = {
        transition: isDragging && displayOrder === 0 ? "none" : "transform 0.5s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.5s ease"
      };
      if (displayOrder === 0) {
      ...
      const tagClass = (type) => type === "featured" ? "bg-primary/20 text-primary border border-primary/30" : "bg-secondary text-secondary-foreground border border-border";
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-5 text-base sm:text-lg text-foreground/90 leading-relaxed flex-1", children: [
              '"',
              testimonial.quote,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: testimonial.tags.map((tag, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: cn(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 text-xs text-muted-foreground", children: testimonial.stats.map((stat, i) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-2", children: testimonials2.map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: cn(
          ...
          activeIndex === index ? "w-8 bg-primary" : "w-1.5 bg-muted-foreground/40"
        )
      },
      index
    )) })
...
const testimonials = [{
  ...
  quote: "Talha turned our raw footage into a cinematic experience. His VFX work elevated the entire short — he sees frames the way directors do.",
  tags: [{
    text: "FEATURED",
    type: "featured"
  }, {
  ...
  stats: [{
    icon: Award,
    text: "Festival Selection"
  }, {
    icon: Clock,
    text: "3 weeks delivery"
  }],
  ...
  quote: "Insanely creative and fast. The particle work and color grade Talha delivered for our music video got us 2M+ views in the first week.",
  tags: [{
    text: "Music Video",
    type: "default"
  }],
  ...
  quote: "Talha's compositing is invisible — and that's the highest compliment. He fixed plates we thought were unusable. A true editor's editor.",
  tags: [{
    text: "FEATURED",
    type: "featured"
  }, {
  ...
  quote: "He treated my indie short like a blockbuster. Patient, collaborative, and his eye for detail made every shot sing.",
  tags: [{
    text: "Indie",
    type: "default"
  }],
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-primary", children: "What I do" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-4xl md:text-5xl font-bold tracking-tight", children: [
          "Crafted with ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-primary", children: "precision" }),
          "."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "From subtle invisible fixes to full-blown sci-fi spectacle, every project is treated with cinematic care." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: services.map(({
        icon: Icon,
        title,
        desc
      }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group glass rounded-2xl p-6 transition-all hover:-translate-y-1 hover:shadow-glow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid size-12 place-items-center rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 text-primary group-hover:from-primary group-hover:to-accent group-hover:text-primary-foreground transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 font-semibold text-lg", children: title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-24 md:py-32 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "pointer-events-none absolute inset-0 opacity-50", style: {
        background: "radial-gradient(ellipse at center, oklch(0.55 0.22 285 / 0.2), transparent 60%)"
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-6xl px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-4xl md:text-5xl font-bold tracking-tight", children: "From directors & creators" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TestimonialStack, { testimonials })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-4xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl glass p-10 md:p-16 text-center shadow-elegant", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "absolute inset-0 opacity-50", style: {
        background: "var(--gradient-hero)"
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold tracking-tight", children: "Have a frame in mind?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground max-w-xl mx-auto", children: "Let's turn your footage into something cinematic." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-accent px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-glow transition-transform hover:scale-105", children: "Start a project →" })
      ] })
    ] }) }) })
  ] });
}
