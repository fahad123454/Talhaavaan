...
export function CinematicHero({
  ...
  // 1. High-Performance Mouse Interaction (rAF + GSAP parallax)
  useEffect(() => {
  ...
  // 2. Cinematic Scroll Timeline (pinned ScrollTrigger)
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        // ----- HOLD the scene so user can read the card -----
        .to({}, { duration: 2 })
        // ----- Fade out card content BEFORE revealing CTA -----
        .to(
          [
            ".card-left-text",
            ".card-right-text",
        ...
        // ----- Now reveal the CTA on a clean stage -----
        .to(
          ".cta-wrapper",
          {
            autoAlpha: 1,
        ...
        // ----- Hold the CTA visible at the end -----
        .to({}, { duration: 1.5 });
    }, containerRef);
